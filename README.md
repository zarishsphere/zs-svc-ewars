...
git clone https://github.com/zarishsphere/zs-svc-ewars.git
cd zs-svc-ewars
...
See [docs.zarishsphere.com/api/zs-svc-ewars](https://docs.zarishsphere.com/api/zs-svc-ewars) for the full OpenAPI 3.1 specification.
